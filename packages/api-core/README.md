...
- `stub: true` — marks synthetic stub-mode output. Stub responses fabricate
  a `PAYMENT_COMPLETED` order for development and must never be treated as
  real payment verification evidence.
