...
export interface WebViewPromotionOptions {
...
export function createWebViewPromotion(options: WebViewPromotionOptions = {}): PromotionAdapter {
...
/** @deprecated Use createWebViewPromotion from @ait-kit/sdk/webview. */
export const createWebPromotion = createWebViewPromotion;
/** @deprecated Use WebViewPromotionOptions from @ait-kit/sdk/webview. */
export type WebPromotionOptions = WebViewPromotionOptions;
